...
?>	
	...
	<div class="row" id="threeSectionC">
			<table class="table table-responsive table-hover">
				<thead>
					<tr>
						<th class="col-md-12 titleSectionC" colspan="4" style="background: #005747;margin-top: -20px;">							
						</th>
					</tr>
					<tr>
...
<script type="text/javascript">
	...
	function modificarActividadA(actividad,curso){		
			     	var noActividad=actividad;
			     	var idCurso=curso;
			        $.ajax({
			            url:'../CTI/controlador/controladorCatedraticos.php?seccion=actividadAspectosEdit',
			            type:'POST',
			            dataType:'json',
