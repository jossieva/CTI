...
<div class="row" id="twoSectionC">
		<div class="col-md-12 titleSectionA">
			<h2 align="center"><strong>Generación del cuadro de Honor</strong></h2>
		</div>
		<ol class="breadcrumb">
		  <li><a href="index.php">Inicio</a></li>
		  <li class="active">Cuadro de Honor</li>
		...
		<div class="col-md-12 alumnos">
			...
			<section>
				...
				<div class="group-form">
					...
					<div class="col-md-8 f1">
						<select name="Unidad" class="form-control selectUnidad" required><span style="color: red">*</span>
							<option>--Seleccione--</option>
							<?php 
								if($arrUnidad){
									foreach($arrUnidad as $data){
										echo "<option value=".$data['COD_UNIDAD'].">".$data['NOMBRE_UNIDAD']."</option>";
									}
								}
							?>
						</select>
