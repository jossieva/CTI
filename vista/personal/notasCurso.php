<div class="row" id="twoSectionC">
		<div class="col-md-12 titleActivity">
			<h2 align="center">Notas por Curso<span class="curso"></span></h2>
		</div>
		<ol class="breadcrumb">
		  <li><a href="index.php">Inicio</a></li>
		  <li class="active">Notas por Actividades de Curso</li>
		...
		<div class="col-md-12 alumnos">
			...
			<div class="row titleSectionC" style="background: #04369a;margin-top: -20px;">
			...
			<div class="row">
				<p align="center">
					<span>
						<a class="btn btn-default imprimirNC" href="#" target="_blank"><i class="fa fa-print fa-3x" style="color: #04369a"></i></a>
					</span>
				</p>
			</div>
			<hr/>
			<div class="row" style="border-bottom: 5px solid #3f73a1">
						<div class="col-md-12">
							...
							<ul class="recomendaciones">
								<li>
									<span class="fa fa-asterisk" aria-hidden="true"></span><strong>NNI</strong> Nota No Ingresada
