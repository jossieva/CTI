<div class="row" id="twoSectionC">
		...
		<div class="col-md-12 alumnos">
			...
			<div class="row titleSectionGeneral" style="background: #04369a;margin-top: -20px;">
			...
			<div class="row">
				<p align="center">
					<span>
						<a class="btn btn-default imprimirNU" href="" target="_blank"><i class="fa fa-print fa-3x" style="color: #04369a"></i></a>
					</span>
				</p>
			</div>
